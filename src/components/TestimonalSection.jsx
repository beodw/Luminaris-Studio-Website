...
import Testimonal1 from "../assets/images/testimonial-01.png"
import Testimonal2 from "../assets/images/testimonial-02.png"
import Testimonal3 from "../assets/images/testimonial-03.png"
						...
						<div className="testimonials-wrap">
								...
								<div className="testimonial-inner">
									<div className="testimonial-main">
										<div className="testimonial-header">
											<img className="mb-16" src={Testimonal1} alt="Testimonial"/>
										</div>
							...
							<div className="testimonial text-xs is-revealing">
								<div className="testimonial-inner">
									<div className="testimonial-main">
										<div className="testimonial-header">
											<img className="mb-16" src={Testimonal2} alt="Testimonial"/>
										</div>
										<div className="testimonial-body">
											<p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
										</div>
							...
							<div className="testimonial text-xs is-revealing">
								<div className="testimonial-inner">
									<div className="testimonial-main">
										<div className="testimonial-header">
											<img className="mb-16" src={Testimonal3} alt="Testimonial"/>
										</div>
										<div className="testimonial-body">
											<p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
										</div>
